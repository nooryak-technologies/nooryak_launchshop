...
class AboutTestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'image' => 'required_without:ai_generated_image|mimes:jpg,jpeg,png',
        ...
        $destDir = public_path('assets/front/img/user/about/testimonial');
        if ($request->hasFile('image')) {
            $in['image'] = Uploader::upload_picture($destDir, $request->file('image'));
