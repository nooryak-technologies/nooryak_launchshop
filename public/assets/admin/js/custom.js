    ...
    if (typeof bootstrap !== 'undefined') {
        ...
        var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEl) {
            return new bootstrap.Tooltip(tooltipTriggerEl, {
                html: true,
                boundary: 'window',
                template: '<div class="tooltip custom-ai-tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>'
            });
        });
        console.log('Tooltips initialized with vanilla JS');
    } else {
