...
Route::group(['prefix' => 'user', 'middleware' => ['auth', 'userstatus', 'Demo', 'userLanguage']], function () {
    ...
    Route::post('/ai/generate/image', [AiImageController::class, 'generateImage'])
        ->name('user.ai.generate.category.image')
    ...
    Route::post('/user/ai/generate-slider-images', [AiImageController::class, 'generateSliderImages'])
        ->name('user.ai.generate.slider.images')
        ->middleware('aiQuotaWarning');
    // user theme change
    ...
    Route::prefix('shop-management/products')->middleware('checkpermission:Shop Management')->group(function () {
        ...
        Route::prefix('items')->group(function () {
            ...
            Route::post('/delete-bulk-image', 'User\ItemController@deleteBulkImage')->name('user.item.delete_bulk_image');
