...
@section('scripts')
  ...
  <script>
    ...
    function updateTabSectionAiLang() {
      var code = $('#create_language option:selected').data('code') || '';
      $('#createModal .ai-field-btn').attr('data-lang', code);
    }

    $(document).on('change', '#create_language', updateTabSectionAiLang);
    $('#createModal').on('shown.bs.modal', updateTabSectionAiLang);
    updateTabSectionAiLang();
