            ...
            <div class="card">
                <div class="card-header additional-card-header">
                    ...
                    <button type="button" class="btn btn-primary btn-sm float-right ml-2 ai-field-btn"
                        ...
                        data-title="{{ __('Generate All Content') }}">
                                        ...
                                        <div class="form-group p-0">
                                            ...
                                            <select name="position" class="form-control select2">
                                                ...
                                                <option value="hero_section">
                                                    {{ $keywords['After Hero Section'] ?? __('After Hero Section') }}
                                                </option>
                                                            ...
                                                            <div
                                                                ...
                                                                <label
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-field="{{ $language->code }}_section_name"
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div
                                                                ...
                                                                <label class="d-flex align-items-center justify-content-between">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-primary ai-field-btn"
                                                                        data-field="{{ $language->code }}_content"
                                                                        data-lang="{{ $language->code }}"
                                                                        data-title="{{ __('Content') }}">
                                                                        <i class="fas fa-magic"></i> {{ __('Generate') }}
                                                                    </button>
                                                                </label>
