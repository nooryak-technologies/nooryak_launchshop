        ...
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{ route('user.home_page.heroSec.how_it_work.store') }}"
            ...
            <div class="form-group">
              ...
              <select name="user_language_id" class="form-control" id="create_language">
                <option value="" selected disabled>{{ __('Select a language') }}
                </option>
                @foreach ($userLanguages as $lang)
            ...
            <div class="form-group">
              <label class="d-flex align-items-center justify-content-between">
                ...
                <button type="button" class="btn btn-sm btn-primary ai-field-btn" data-field="title" data-lang=""
                  data-title="{{ __('Title') }}">
            ...
            <div class="form-group">
              <label class="d-flex align-items-center justify-content-between">
                <span>{{ __('Text') }} <span class="text-danger">**</span></span>
                <button type="button" class="btn btn-sm btn-primary ai-field-btn" data-field="text" data-lang=""
                  data-title="{{ __('Text') }}">
                  <i class="fas fa-magic"></i> {{ __('Generate') }}
                </button>
              </label>
...
@section('scripts')
  ...
  <script>
    ...
    function updateHowItWorkAiLang() {
      var code = $('#create_language option:selected').data('code') || '';
      $('#createModal .ai-field-btn').attr('data-lang', code);
    }

    $(document).on('change', '#create_language', updateHowItWorkAiLang);
    $('#createModal').on('shown.bs.modal', updateHowItWorkAiLang);
    updateHowItWorkAiLang();
