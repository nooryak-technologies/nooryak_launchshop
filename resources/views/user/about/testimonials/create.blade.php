              ...
              <div class="form-group">
                ...
                <div class="col-md-12 showImage mb-3 pl-0  pr-0">
                  <img src="{{ asset('assets/admin/img/noimage.jpg') }}" alt="..." class="img-thumbnail"
                    id="testimonial_image_preview">
                </div><br>
                <input type="hidden" name="ai_generated_image" id="ai_generated_testimonial_image">
                <div class="d-flex align-items-center flex-wrap" style="gap:10px;">
                  ...
                  <button type="button" class="btn btn-info btn-sm" data-ai-image-open
                    ...
                    data-target="#testimonial_image_preview"
                    data-hidden="#ai_generated_testimonial_image"
