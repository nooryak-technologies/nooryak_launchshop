    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn btn-primary btn-sm ml-2 ai-field-btn"
            data-field="" data-lang="" data-title="{{ __('Generate All') }}" id="aiGenerateItemSeoBtn">
            <i class="fas fa-magic mr-1"></i> {{ __('Generate All') }}
          </button>
            ...
            @foreach ($userLanguages as $lang)
              <div class="form-group">
                <label class="d-flex align-items-center justify-content-between">
                  <span>{{ __('Name') }} ({{ $lang->name }}) @if ($lang->is_default == 1)
                      <span class="text-danger">**</span>
                    @endif
                  </span>
                  <button type="button" class="btn btn-sm btn-primary ai-field-btn" data-field="{{ $lang->code }}"
                    data-lang="{{ $lang->code }}" data-title="{{ __('Name') }}">
