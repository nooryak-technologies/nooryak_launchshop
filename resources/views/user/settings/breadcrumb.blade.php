                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12 showImage mb-3 pl-0 pr-0">
                        <img
                          ...
                          alt="..." class="img-thumbnail" id="breadcrumb_preview">
                      </div><br>
                      <input type="hidden" name="ai_generated_breadcrumb" id="ai_generated_breadcrumb">
                      <div class="d-flex align-items-center flex-wrap" style="gap:10px;">
                        ...
                        <button type="button" class="btn btn-info btn-sm" data-ai-image-open
                          ...
                          data-target="#breadcrumb_preview" data-hidden="#ai_generated_breadcrumb"
