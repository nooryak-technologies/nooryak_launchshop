                ...
                <div class="accordion accordion-secondary mt-3" id="accordion">
                  @foreach ($userLangs as $language)
                    <div class="version">
                      ...
                      <div id="collapse{{ $language->id }}" data-lang="{{ $language->code }}"
                        ...
                        <div class="card-body">
                              ...
                              <div class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                <label class="d-flex align-items-center justify-content-between">
                                  ...
                                  <button type="button" class="btn btn-sm btn-primary ai-field-btn"
                                    data-field="{{ $language->code }}_title" data-lang="{{ $language->code }}"
                                    data-title="{{ __('Title') }} ({{ $language->name }})">
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                <label class="d-flex align-items-center justify-content-between">
                                  <span>{{ __('Body') }} <span class="text-danger">**</span></span>
                                  <button type="button" class="btn btn-sm btn-primary ai-field-btn"
                                    data-field="{{ $language->code }}_body" data-lang="{{ $language->code }}"
                                    data-title="{{ __('Body') }} ({{ $language->name }})">
                                    <i class="fas fa-magic"></i> {{ __('Generate') }}
                                  </button>
                                </label>
