                            ...
                            <form id="permissionsForm" class="" action="{{ route('admin.package.features_update') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup selectgroup-pills">
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Posts Limit"
                                                class="selectgroup-input" @if (is_array($features) && in_array('Posts Limit', $features)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Posts Limit') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Google Login"
                                                class="selectgroup-input" @if (is_array($features) && in_array('Google Login', $features)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Google Login') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Google Analytics"
                                                class="selectgroup-input" @if (is_array($features) && in_array('Google Analytics', $features)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Google Analytics') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Facebook Pixel"
                                                class="selectgroup-input" @if (is_array($features) && in_array('Facebook Pixel', $features)) checked @endif>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Google Recaptcha"
                                                class="selectgroup-input" @if (is_array($features) && in_array('Google Recaptcha', $features)) checked @endif>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="AI Content & Image Generator"
                                                class="selectgroup-input"
                                                @if (is_array($features) && in_array('AI Content & Image Generator', $features)) checked @endif>
                                            <span
