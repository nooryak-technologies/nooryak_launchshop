                        ...
                        <div class="col-lg-6 m-auto">
                            <form id="ajaxForm" class="" action="{{ route('admin.package.update') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="price">{{ __('Price') }} ({{ $bex->base_currency_text }})
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="plan_term" name="term" class="form-control">
                                                <option value="" selected disabled>{{ __('choose_plan_term') }}
                                                </option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="selectgroup selectgroup-pills">
                                                ...
                                                <label class="selectgroup-item">
                                                    <input type="checkbox" name="features[]" id="post_limit_feature"
                                                        value="Blog" class="selectgroup-input"
                                                        @if (is_array($permissions) && in_array('Blog', $permissions)) checked @endif>
                                                    <span class="selectgroup-button">{{ __('Blog') }}</span>
                                                </label>

                                                <label class="selectgroup-item">
                                                    <input type="checkbox" name="features[]" id=""
                                                        value="Custom Page" class="selectgroup-input"
                                                ...
                                                <label class="selectgroup-item">
                                                    <input type="checkbox" name="features[]" value="WhatsApp Chat Button"
                                                        class="selectgroup-input"
                                                        @if (is_array($permissions) && in_array('WhatsApp Chat Button', $permissions)) checked @endif>
                                                    <span
                                                        class="selectgroup-button">{{ __('WhatsApp Chat Button') }}</span>
                                                </label>
                                                ...
                                                <label class="selectgroup-item">
                                                    <input type="checkbox" name="features[]"
                                                        value="AI Content & Image Generator" class="selectgroup-input"
                                                        @if (is_array($permissions) && in_array('AI Content & Image Generator', $permissions)) checked @endif>
                                                    <span
                                                        class="selectgroup-button">{{ __('AI Content & Image Generator') }}</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6" id="post_limit"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="post_limit" type="number" class="form-control" name="post_limit"
                                                placeholder="{{ __('Enter Blog Post Limit') }}"
                                                value="{{ $package->post_limit }}">
                                    ...
                                    <div class="col-md-6" id="product_limit" style="display: {{ $d_block }}">
                                        <div class="form-group">
                                            <label for="product_limit">{{ __('Product Limit') }} <span
                                                    class="text-danger">**</span>
                                                {{ $package->post_limit == 999999 ? __('(Unlimited)') : '' }}</label>
                                            <input id="product_limit" type="number" class="form-control"
                                                name="product_limit" placeholder="{{ __('Enter Product Limit') }}"
                                                value="{{ $package->product_limit }}">
                                    ...
                                    <div class="col-md-6" id="order_limit" style="display: {{ $d_block }}">
                                        <div class="form-group">
                                            <label for="order_limit">{{ __('Order Limit') }} <span
                                                    class="text-danger">**</span>
                                                {{ $package->post_limit == 999999 ? __('(Unlimited)') : '' }}</label>
                                            <input id="order_limit" type="number" class="form-control"
                                                name="order_limit" placeholder="{{ __('Enter Order Limit') }}"
                                                value="{{ $package->order_limit }}">
                                    ...
                                    <div class="col-md-6" id="language_limit" style="display: {{ $d_block }}">
                                        <div class="form-group">
                                            <label for="language_limit">{{ __('Additional Language Limit') }} <span
                                                    class="text-danger">**</span>
                                                {{ $package->post_limit == 999999 ? __('(Unlimited)') : '' }}</label>
                                            <input id="language_limit" type="number" class="form-control"
                                                name="language_limit"
                                    ...
                                    <div
                                        class="col-md-6 ai-feature-box {{ is_array($permissions) && in_array('AI Content & Image Generator', $permissions) ? '' : 'd-none' }}">
                                        <div class="form-group">
                                            <label for="ai_engine">{{ __('AI Engine') }} <span
                                                    class="text-danger">**</span></label>
                                            <select id="ai_engine" name="ai_engine" class="form-control">
                                                <option value="" disabled>{{ __('Choose AI Engine') }}</option>
                                                <option value="gemini"
                                                    {{ $package->ai_engine == 'gemini' ? 'selected' : '' }}>
                                                    {{ __('Gemini') }}
                                                </option>
                                                <option value="openai"
                                                    {{ $package->ai_engine == 'openai' ? 'selected' : '' }}>
                                                    {{ __('OpenAI') }}
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6" id="trial_day" style="display: {{ $d_block }}">
                                            <div class="form-group">
                                                <label for="trial_days_2">{{ __('Trial days') }} <span
                                                        class="text-danger">**</span></label>
                                                <input id="trial_days_2" type="number" class="form-control"
                                        ...
                                        <div class="col-md-6" id="trial_day" style="display: {{ $d_none }}">
                                            <div class="form-group">
                                                <label for="trial_days_1">{{ __('Trial days') }} <span
                                                        class="text-danger">**</span></label>
                                                <input id="trial_days_1" type="number" class="form-control"
                                                    name="trial_days" placeholder="{{ __('Enter trial days') }}"
                                                    value="{{ $package->trial_days }}">
                                                <p class="text-warning">{{ __('999999 count as Unlimited') }}</p>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="meta_keywords" type="text" class="form-control"
                                                name="meta_keywords" value="{{ $package->meta_keywords }}"
                                                data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
