...
/* ==========================================================================
   SUPER FLASH SALE CARD FIX & 1600PX LARGE SCREEN ALIGNMENTS
   ========================================================================== */

/* Fix Flash Sale Product Card White Space & Padding Issue */
.product-default-9 {
  position: relative !important;
...
/* 1600px Large Screen Alignments */
@media (min-width: 1600px) {
  /* Center Header Logo */
  ...
  /* Section Container Centering for 1600px */
  .container {
