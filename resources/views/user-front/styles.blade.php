...
<link rel="stylesheet" href="{{ asset('assets/user-front/css/common/zoom-fix.css?v=1.0.7') }}">
...
@elseif ($userBs->theme == 'manti')
  ...
  <link rel="stylesheet" href="{{ asset('assets/user-front/css/manti/custom-styles.css?v=1.0.7') }}">
