...
@section('content')
  ...
  <div class="banner-collection pt-70 d-none d-lg-block">
    <div class="container">
      <div class="row">
  ...
  @if ($banners && count($banners) > 0)
    ...
    <div class="banner-slider-mobile-wrap d-block d-lg-none pt-70 pb-30">
      <div class="container">
        <div class="banner-slider-mobile" id="banner-slider-mobile-kids">
          @foreach ($banners as $banner)
            <div class="px-2">
              <div class="banner-sm radius-lg ratio ratio-16-9">
                <img class="bg-img" src="{{ asset('assets/front/images/placeholder.png') }}"
                  data-src="{{ asset('assets/front/img/user/banners/' . $banner->banner_img) }}" alt="Banner">
                <div class="banner-content mw-80">
                  <div class="content-inner">
...
<script>
  $(document).ready(function() {
    if ($('#banner-slider-mobile-kids').length > 0) {
      $('#banner-slider-mobile-kids').slick({
        dots: false,
        arrows: false,
        autoplay: true,
        autoplaySpeed: 3000,
