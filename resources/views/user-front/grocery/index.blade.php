        ...
        <div class="row">
          ...
          @if ($ubs->top_right_banner_section == 1)
            ...
            @if ($banners)
              ...
              @endphp
              @if (count($rightBanners) > 0)
                <div class="col-12 d-block d-lg-none mb-30">
                  <div class="banner-slider-mobile" id="banner-slider-mobile-grocery">
                    @foreach ($rightBanners as $banner)
                      <div class="px-2">
                        <div class="banner-sm radius-xl ratio ratio-5-3">
                          <img class="bg-img" src="{{ asset('assets/front/images/placeholder.png') }}"
                            data-src="{{ asset('assets/front/img/user/banners/' . $banner->banner_img) }}"
                            alt="Banner">
                          <div class="banner-content">
                            <div class="content-inner">
                              <span class="sub-title lc-1">{{ $banner->title }}</span>
                              <h3 class="title-sm lc-2">{{ $banner->subtitle }}</h3>
...
<script>
  $(document).ready(function() {
    if ($('#banner-slider-mobile-grocery').length > 0) {
      $('#banner-slider-mobile-grocery').slick({
        dots: false,
        arrows: false,
        autoplay: true,
        autoplaySpeed: 3000,
