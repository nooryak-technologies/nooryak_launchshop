...
<footer class="footer-area footer-v7">
  ...
  <img class="lazyload blur-up bg-img"
    data-src="{{ !is_null(@$footer->background_image) ? asset('assets/front/img/footer/' . $footer->background_image) : asset('assets/user-front/images/skinflow/footer-bg.jpg') }}"
    alt="Bg-img">
      ...
      <div class="row gx-xl-5">
        <div class="col-lg-4 col-md-12">
          <div class="footer-widget">
            ...
            <p class="text fw-medium footer_description">{{ @$footer->footer_text ?? '' }}</p>
