      ...
      <div class="row align-items-center gy-4">
        ...
        <div class="col-lg-6">
          <div class="urban-about-hero-img-wrap">
            <img src="{{ asset('assets/user-front/images/clothing/urban_about_hero.png') }}" alt="About Urban">
          </div>
        </div>
      </div>
    </div>
...
@endif
  ...
  @if ($userBs->about_features_section == 1)
    ...
    <section class="featured featured-2 ">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="about-image mb-30 ratio ratio-5-4 blur-up lazyload">
              <img class="ls-is-cached lazyload radius-sm" src="{{ asset('assets/front/images/placeholder.png') }}"
                data-src="{{ ($userBs->theme == 'clothing') ? asset('assets/user-front/images/clothing/urban_about_counter.png') : (!is_null(@$counterSection->image) ? asset('assets/front/img/user/about/' . @$counterSection->image) : asset('images/actvment.png')) }}"
                alt="about-image">
            </div>
          </div>
          <div class="col-lg-6">
